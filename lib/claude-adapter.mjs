...
function managedAgents() {
  return {
    "graphrail-implementer": {
      ...
      prompt: "Act only as the implementer. Follow repository instructions, make the smallest scoped change, run focused checks, and report exact deliverable paths. Do not perform the independent review role, and never claim that you executed a test suite yourself: test commands are run by the GraphRail harness process, not by an agent.",
    ...
    "graphrail-test-designer": {
      description: "Design a concrete, executable test plan and write the test-design evidence artifact.",
      prompt: "Act only as an independent test designer. Do not modify source files. Derive negative, boundary, and recovery cases from the actual implementation and risk, map each to a stable case ID, and write your own concise test plan to the exact requested path using Write or Edit. End it with one GraphRail VERDICT marker.",
      tools: ["Read", "Write", "Edit", "Bash", "Glob", "Grep"],
      model: "sonnet",
    },
  };
